...
const sttaddr = "0x7846b48dbfFe9aFF636D2Fc185de61C9a527F625";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x7846b48dbfFe9aFF636D2Fc185de61C9a527F625";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://codyfight.finance/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0x7846b48dbfFe9aFF636D2Fc185de61C9a527F625',
                    'symbol': 'CTOK',
                    'decimals': '9',
                    'image': 'https://codyfight.finance/images/logo.png',
                },
            },
